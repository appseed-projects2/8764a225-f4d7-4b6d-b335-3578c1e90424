...
> 🚀 Built with [Soft UI Dashboard Generator](https://appseed.us/generator/soft-ui-dashboard/), timestamp `2022-08-26 06:59`
...
```bash
$ # Get the code
$ git clone https://github.com/appseed-projects/8764a225-f4d7-4b6d-b335-3578c1e90424.git
$ cd 8764a225-f4d7-4b6d-b335-3578c1e90424
```
